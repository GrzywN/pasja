...
function Appointment() {
  return (
    <section
      className="px-8 w-full min-h-screen grid place-content-center gap-6 md:gap-12 2xl:gap-24"
    ...
    >
      ...
      <div className="bg-white mx-auto max-w-5xl grid gap-12 lg:gap-18 p-8 lg:max-w-6xl 2xl:max-w-7xl">
        ...
        <a
          className="underline underline-offset-2 text-center text-3xl tracking-tight transition text-black sm:text-6xl md:text-7xl xl:no-underline 2xl:text-8xl"
